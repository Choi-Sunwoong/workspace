...
<head>
    ...
    <title>2. Servlet/JSP ë´ì¥ ê°ì²´ì ë²ì(sccope)</title>
</head>
<body>
    ...
    <pre>
    	...
    	2. request : 요청받은페이지(Servlet/JSP)와 
    				요청을 위임받은 페이지(Servler/JSP)에서 사용 가능
    				(최소 2페이지 이상)
    	...
    	*******************************
    	...
    	-> setAttriubte("key", value)로 내장 객체가 값을 세팅할 떄
    		key 값이 중복되는 경우
    ...
    <ul>
    	<li>
    	<%
    		pageContext.setAttribute("pageMsq", "페이지 범위 입니다.");
    	
    		pageContext.setAttribute("str", "page scope");
    	%>
    	
    	page scope pageMsq : ${pageMsq}
    	</li>
