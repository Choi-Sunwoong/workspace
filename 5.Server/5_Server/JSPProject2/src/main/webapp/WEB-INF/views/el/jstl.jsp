...
<%--
	prefix : 접두사
	uri(Uniform Resource Identifier) : 자원을 구분하는 식별자(구분하는 형태)
 --%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <ol>
    	<li>http://tomcat.apache.org/download-taglibs.cqi 접속</li>
	 ...
	 --%>	
	  <c:if test='${ sessionScope.test == "session" }'>
	   ...
	   <c:if test='${ sessionScope.test != "session" }'>
	 	...
	 	<h1>4. 조건문 - if ~ else if ~ else ( c:chose, c:when, c:otherwise)</h1>
	 	<pre>
