...
public class SetService {
	...
	public void ex1() {
		...
		set.add("배민");
		set.add(null);
		// 중복값이 허용되지 않는다. 배민 여러번 입력해도 한번만 뜸!
		...
		// List는 index가 있어서 get()로 요소 하나 얻어오 수 있었지만,
		// Set은 순서가 없어서 저장된 객체 하나늘 얻어올 수 있는 방법이 없다!
	...
	public void ex4() {
		...
		System.out.println("int 최대값 : " + w1.MIN_VALUE); // static
		
		System.out.println("double 최대값 : " + w1.MAX_VALUE); // static
		System.out.println("double 최대값 : " + w1.MIN_VALUE); // static
		
		System.out.println("=========static 방식ㅇ로 Wrapper클래스 사용=========");
		...
		System.out.println("double 최대값 : " + Double.MIN_VALUE); // static
	...
	//(Integer)		( int -> Integer ) 자동포장
		...
		// Integer + Integer -> int + int (자동포장해체)
							// AutoBoxing
