...
public class MemberController {
	...
	// 이메일 중복 검사
	@ResponseBody // 응답 시 사용!
	@GetMapping("/nicknameDupCheck")
	public int nicknameDupCheck( @RequestParam("memberNickname") String memberNickname) { // 파라미터 key값과 저장하려는 변수 명이 같으면 생략가능!
	...
	public int emailDupCheck( @RequestParam("memberEmail") String memberEmail) { // 파라미터 key값과 저장하려는 변수 명이 같으면 생략가능!
